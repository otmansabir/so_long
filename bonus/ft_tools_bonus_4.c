...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/23 10:42:15 by osabir            #+#    #+#             */
/*   Updated: 2023/03/23 10:50:06 by osabir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (help->map[help->plyer_y][help->plyer_x - 1] == 'C')
	{
		help->map[help->plyer_y][help->plyer_x - 1] = '0';
		help->coin--;
	}
	if (help->map[help->plyer_y][help->plyer_x - 1] == 'M')
		loser(help);
...
{
	if (help->map[help->plyer_y - 1][help->plyer_x] == 'C')
	{
		help->map[help->plyer_y - 1][help->plyer_x] = '0';
		help->coin--;
	}
	if (help->map[help->plyer_y - 1][help->plyer_x] == 'M')
		loser(help);
...
void	func_move_hero_part1(int key, t_tools *help)
{
	if ((key == 123 || key == 0)
		...
		&& help->map[help->plyer_y][help->plyer_x - 1] != 'E')
	...
	if ((key == 126 || key == 13)
		...
		&& help->map[help->plyer_y - 1][help->plyer_x] != 'E')
